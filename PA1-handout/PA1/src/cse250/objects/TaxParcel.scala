...
class TaxParcel {
  ...
  override def hashCode: Int = parcelInfo.hashCode
}

object TaxParcel {
  val HEADERS = Array("SBL","TAX DISTRICT","PRINT KEY","FRONT","DEPTH","PROPERTY CLASS","PROPERTY CLASS DESCRIPTION","PREVIOUS PROPERTY CLASS","HOUSE NUMBER","STREET","ADDRESS","CITY","STATE","ZIP CODE (5-DIGIT)","LAND VALUE","TOTAL VALUE","SALE PRICE","YEAR BUILT","TOTAL LIVING AREA","OVERALL CONDITION","# OF FIREPLACES","# OF BEDS","# OF BATHS","COUNCIL DISTRICT","POLICE DISTRICT","NEIGHBORHOOD","LATITUDE","LONGITUDE","LOCATION")
}