/**
 * cse250.examples.graph.EdgeListGraph.scala
 *
...
class EdgeListGraph[VType, EType] extends cse250.examples.types.mutable.GraphADT[VType, EType] {
  ...
  case class EdgeListVertex(override var _elem: VType) extends Vertex {
    private[EdgeListGraph] val _position = new ListPosition[Vertex](this, null, null)
  }

  case class EdgeListEdge(override val _u: Vertex, override val _v: Vertex, override val _elem: EType) extends Edge {
  ...
  override def removeEdge(e: Edge): Unit = {
    ...
    val pos = e.asInstanceOf[EdgeListEdge]._position
